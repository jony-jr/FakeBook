...
export default function Footer() {
  return (
    <>
      <footer className="bg-gray-50 rounded-t-lg shadow-sm dark:bg-gray-900 ">
        <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
          <div className="sm:flex sm:items-center sm:justify-between">
            <NavLink to="" className="flex items-center mb-4 sm:mb-0 space-x-3 rtl:space-x-reverse">
              <span className="text-blue-600 self-center text-2xl font-semibold whitespace-nowrap dark:text-white">FakeBook</span>
            </NavLink>
          ...
          <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">©2025 AW. All Rights Reserved.</span>
        </div>
      </footer>
    </>
  )
